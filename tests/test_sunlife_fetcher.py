...
from src import sunlife_fetcher as fetcher
...
def test_fetch_job_description_uses_workday_json():
    ...
    with patch.object(fetcher.requests, "request", return_value=response):
        description, date = fetcher.fetch_job_description("https://sunlife.wd3.myworkdayjobs.com/en-US/Experienced/job/x_R1")

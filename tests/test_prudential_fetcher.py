...
from src import prudential_fetcher as fetcher
...
def test_fetch_job_description_uses_workday_json():
    ...
    with patch.object(fetcher.requests, "request", return_value=response):
        description, date = fetcher.fetch_job_description("https://prudential.wd3.myworkdayjobs.com/en-US/prudential/job/x_R1")

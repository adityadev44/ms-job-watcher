"""
Oracle / Oracle Health job fetcher — Oracle HCM Cloud Candidate Experience REST API.

Plain HTTP requests, no Playwright needed. Same API pattern as dell_fetcher
but different tenant (eeho.fa.us2.oraclecloud.com) and site number (CX_45001).

Oracle Health jobs are integrated into Oracle's main careers platform — no
separate search needed.
"""
...
_BASE_URL = "https://eeho.fa.us2.oraclecloud.com"
...
_JOB_BASE = f"{_BASE_URL}/hcmUI/CandidateExperience/en/sites/jobsearch/job"

_SITE_NUMBER = "CX_45001"
_INDIA_LOCATION_FACET_ID = 300000000106947
_PAGE_SIZE = 25
...
_HEADERS = {
    ...
    "ora-irc-language": "US",
    "Referer": f"{_BASE_URL}/hcmUI/CandidateExperience/en/sites/jobsearch/jobs",
}
    ...
    *,
    ...
    for attempt in range(3):
        try:
            ...
            if attempt == 2:
                raise RateLimitError(f"Oracle search failed after 3 attempts: {exc}") from exc

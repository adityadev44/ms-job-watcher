"""DoorDash India jobs from its official Greenhouse board.
...
_TOKEN="doordashindia";_URL=f"https://boards-api.greenhouse.io/v1/boards/{_TOKEN}/jobs";_HEADERS={"User-Agent":"Mozilla/5.0","Accept":"application/json"}
_INDIA=("india","hyderabad","bengaluru","bangalore","mumbai","gurgaon","gurugram","delhi","noida","pune","chennai")
...
def _fill(timeout):
 ...
 for attempt in range(3):
  try:
   ...
   if attempt==2:raise RateLimitError(f"DoorDash Greenhouse fetch failed: {exc}") from exc

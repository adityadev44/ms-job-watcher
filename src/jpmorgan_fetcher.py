"""JPMorgan Chase job fetcher — Oracle HCM Cloud Candidate Experience REST API.

Plain HTTP requests work — raw Oracle Cloud tenant domain (jpmc.fa.oraclecloud.com),
same pattern as chubb_fetcher.py / oracle_fetcher.py / wtw_fetcher.py, no
Akamai blocking. Site CX_1001, India location facet ID 300000000289360.
"""
...
_BASE_URL = "https://jpmc.fa.oraclecloud.com"
...
_JOB_BASE = f"{_BASE_URL}/hcmUI/CandidateExperience/en/sites/CX_1001/job"

_SITE_NUMBER = "CX_1001"
_INDIA_LOCATION_FACET_ID = 300000000289360
_PAGE_SIZE = 25
...
_HEADERS = {
    ...
    "ora-irc-language": "US",
    "Referer": f"{_BASE_URL}/hcmUI/CandidateExperience/en/sites/CX_1001/jobs",
}
    ...
    *,
    ...
    for attempt in range(3):
        try:
            ...
            if attempt == 2:
                raise RateLimitError(f"JPMorgan Chase search failed after 3 attempts: {exc}") from exc

"""
Chubb insurance job fetcher — Oracle HCM Cloud Candidate Experience REST API.

Plain HTTP requests, no Playwright needed. Same API pattern as oracle_fetcher
but different tenant (fa-ewgu-saasfaprod1.fa.ocs.oraclecloud.com) and site (CX_2001).
"""
...
_BASE_URL = "https://fa-ewgu-saasfaprod1.fa.ocs.oraclecloud.com"
...
_INDIA_LOCATION_FACET_ID = 300000000467203
_PAGE_SIZE = 25
    ...
    *,
    ...
    for attempt in range(3):
        try:
            ...
            if attempt == 2:
                raise RateLimitError(f"Chubb search failed after 3 attempts: {exc}") from exc

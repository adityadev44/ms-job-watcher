...
_IGNORES_KEYWORDS = frozenset(
    {
        "abinbev", "agoda", "airbnb", "airindia", "airtel", "akasaair", "allianztech",
        "alphasense",
        "amdocs", "americanairlines", "anz",
        "appliedsystems", "aqr", "arcesium",
        "atlassian",
        "bankofamerica", "birlasoft", "bnpparibas", "boeing", "bookingcom", "clearwater", "clevertap",
        ...
        "eightfold",
        "energyexemplar", "evernorth", "eygds", "flipkart", "gitlab", "glean", "globallogic", "globant",
        "godrej", "gsk",
...
_INLINE_DESCRIPTIONS = frozenset(
    {
        "abinbev", "agoda", "airtel", "akasaair", "amazon", "aon", "arcesium",
        "atlassian", "bookingcom", "clevertap",
        ...
        "meesho", "morningstar", "msci", "navi", "newgen", "nucleussoftware", "observeai", "payoneer", "paytm", "pepsico", "salesforce",
        "schneiderelectric",
        "sita",
        "sarvam", "towerresearch", "uipath", "signzy", "snowflake", "stripe",
        "policybazaar", "postman", "publicissapient", "razorpay", "sharechat",
        "spglobal_careers",
        "swiggy", "ubs", "whatfix", "worldquant", "xoriant", "yubi", "zerodha", "zeta",
    }
)

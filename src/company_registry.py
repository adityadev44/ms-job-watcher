...
_IGNORES_KEYWORDS = frozenset(
    {
        ...
        "atlassian",
        "bankofamerica", "birlasoft", "bmw", "bnpparibas", "boeing", "bookingcom", "clearwater", "clevertap",
        ...
        "techmahindra", "thoughtworks", "tigeranalytics", "towerresearch", "uber", "ubs", "uipath", "vedanta",
        "whatfix", "wipro", "worldquant", "xoriant", "yash", "yubi", "zerodha", "zeta",
        "zoho", "zomato", "zscaler", "zsassociates",
...
_INLINE_DESCRIPTIONS = frozenset(
    {
        ...
        "atlassian", "bookingcom", "clevertap", "latentview",
        ...
        "schneiderelectric",
        "sita",
        "sarvam", "sigmoid", "towerresearch", "uipath", "signzy", "snowflake", "stripe",
        "policybazaar", "postman", "publicissapient", "razorpay", "sharechat",
        "spglobal_careers",
        "swiggy", "ubs", "whatfix", "worldquant", "xoriant", "yubi", "zerodha", "zeta", "zscaler",
        "zsassociates",
...
_USES_PLAYWRIGHT = frozenset(
    {"ashokleyland", "axtria", "bnpparibas", "darwinbox", "globallogic", "honeywell", "ibm", "indigo",
     "latentview", "natwest", "perfios", "safran", "servicenow", "sonatasoftware",
     "techmahindra", "uber", "virtusa",
     "toyota", "volkswagen"}
)

...
_IGNORES_KEYWORDS = frozenset(
    {
        ...
        "delta", "deltatre", "deshaw", "deutsche", "disney", "dover",
        "eightfold",
...
_INLINE_DESCRIPTIONS = frozenset(
    {
        ...
        "databricks", "dazn", "definitivehealthcare", "deshaw", "energyexemplar",
        "epam", "gallagher",
        "gitlab", "glean", "globant", "google", "groww", "healthedge", "ice",
        "indigo", "juspay",
        "kpit", "lenskart", "m2p", "moengage", "mongodb",
        "meesho", "morningstar", "msci", "navi", "newgen", "payoneer", "paytm", "pepsico", "salesforce",
        "schneiderelectric",
        "sita",

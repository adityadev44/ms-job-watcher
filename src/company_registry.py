...
_IGNORES_KEYWORDS = frozenset(
    {
        ...
        "atlassian",
        "bankofamerica", "bigbasket", "birlasoft", "bmw", "bnpparibas", "boeing", "bookingcom", "byjus", "cashfree", "clearwater", "clevertap",
        ...
        "delta", "deltatre", "deshaw", "deutsche", "disney", "doordash", "dover", "dunbradstreet", "dunzo",
        "eightfold",
        ...
        "persistent", "policybazaar", "porter", "postman", "progresssoftware", "publicissapient",
        "qatarairways", "qualcomm", "questsoftware", "rapido", "razorpay", "reliance", "resideo", "rippling",
...
_USES_PLAYWRIGHT = frozenset(
    {"ashokleyland", "axtria", "bigbasket", "bnpparibas", "darwinbox", "globallogic", "honeywell", "ibm", "indigo",
     "latentview", "natwest", "perfios", "porter", "rapido", "safran", "servicenow", "sonatasoftware",

...
_IGNORES_KEYWORDS = frozenset(
    {
        ...
        "atlassian",
        "bankofamerica", "birlasoft", "bnpparibas", "boeing", "coforge", "cognizant",
        "cred", "crisil", "cyient",
        "datarobot", "dazn", "delta", "deltatre", "deutsche", "disney", "dover",
        "energyexemplar", "flipkart", "glean", "globant",
        ...
        "techmahindra", "thoughtworks", "ubs", "uipath", "wipro", "xoriant",
        "yash", "yubi", "zerodha", "zeta", "zomato",
    }
)
...
_INLINE_DESCRIPTIONS = frozenset(
    {
        ...
        "dazn", "definitivehealthcare", "energyexemplar", "epam", "gallagher",
        "glean", "globant", "google", "groww", "healthedge", "ice", "juspay",
        "kpit", "lenskart", "m2p",
